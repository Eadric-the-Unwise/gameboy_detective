...
C:\c_code\gbdk\bin\png2mtspr C:\c_code\projects\detective\detective_metasprite\tiles\cig_shine.png -sh 16 -spr8x8 -c C:\c_code\projects\detective\detective_metasprite\tiles\cig_shine.c
