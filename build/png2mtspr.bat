...
C:\c_code\gbdk\bin\png2mtspr C:\c_code\projects\detective\detective_metasprite\tiles\smoke.png -sh 16 -spr8x8 -c C:\c_code\projects\detective\detective_metasprite\tiles\smoke.c