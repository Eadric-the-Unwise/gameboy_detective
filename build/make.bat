del main.gb
C:\c_code\projects\detective\detective_metasprite\build\gb_map_converter\gb_map_converter.exe -i ..\maps\bkg_apartment_scroll.png -n bkg_apartment_scroll -o ..\maps

C:\c_code\gbdk\bin\lcc.exe -Wl-j -Wm-yS -o main.gb ..\main.c ..\tiles\tile_detectivewalk.c ..\tiles\cig_shine.c ..\tiles\smoke.c ..\maps\bkg_apartment_map.c ..\maps\bkg_apartment_tiles.c ..\maps\bkg_apartment_scroll_map.c ..\maps\bkg_apartment_scroll_tiles.c ..\tiles\bkg_apartment_lamp_top.c ..\tiles\bkg_apartment_lamp_bot.c ..\tiles\apartment_smoke.c
